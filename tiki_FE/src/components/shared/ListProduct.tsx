...
import { PropsType_ListProduct } from '@/dto/tikiDto';

export const ListProduct = ({ data, cardStyle }: PropsType_ListProduct) => {
  ...
  return (
    <div className='relative group'>
      ...
      <div
        ...
        // 'flex gap-[0.677%] w-full flex-shrink-0 relative group'
        style={{
